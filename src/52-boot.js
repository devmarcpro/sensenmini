...
function chargementComplet(){
  try{
    return !!(EL&&MAT&&CAT&&BIOME&&FORM&&COMP&&FUNC&&SLOTS&&MODULE&&DOMAIN&&SKILLS&&SK&&STATS&&RACE&&CLASSE
      ...
      &&CREATURE&&noteBestiaire&&PATTERN&&VOX&&VOXMAT&&voxelHtml&&matHtml&&compHtml&&ICONE&&iconeHtml&&AFFU&&PARURE&&mkParure&&util&&VEHICULE&&vehVitesse&&primeAjout&&volerOffre&&recelerTout&&CONSO&&consoFaire&&PECHE&&pecheTick&&GARDIEN&&ARTEFACT&&gardienTick&&GESTES&&seqTick&&pCombat&&heroHtml&&vide&&STANCE&&attack&&compileSpell&&harvestTick&&tickClock&&step&&paint&&grp&&foldHead
