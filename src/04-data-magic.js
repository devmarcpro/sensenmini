...
const MODULE={
  ...
  nova:{n:'Déflagration',t:'effet',mana:18,pow:28,d:['feu','corruption','eau'],x:'3d6 en cercle'},
  ...
  mains:{n:'Mains brûlantes',t:'effet',mana:6,pow:10,d:['feu'],x:'cône court, bon marché'},
  ...
  brume:{n:'Brume',t:'effet',mana:10,pow:3,status:{k:'affaibli',dur:5,v:1},d:['eau','espace'],x:'affaiblit 5 s'},
  ...
  orage:{n:'Orage local',t:'effet',mana:25,pow:30,status:{k:'etourdi',dur:.8,v:1},d:['foudre'],x:'zone, lourd'},
  ...
  seisme:{n:'Séisme mineur',t:'effet',mana:22,pow:24,status:{k:'etourdi',dur:1.2,v:1},d:['terre']},
  ...
  eclats:{n:'Éclats de fer',t:'effet',mana:9,pow:7,count:3,d:['metal'],x:'trois éclats'},
...
const PASSIF_TXT={dmg:'dégâts {p}%',pierce:'perforation {p}%',gardecost:'garde {p}% d\'endurance',regen:'endurance {v}/s',win:'fenêtre de parade {p}%',
  ...
  def:'réduction {v}',stagger:'chancellement {p}%',crit:'critique {v}',weaken:'la chaîne résolue affaiblit la cible',endcost:'coût d\'endurance {p}%',staggerE:'la lourde chancelle {v} s de plus'};
