...
const CULT={
  ...
  germanique:{n:'Germanique',a:['Adal','Ber','Diet','Gott','Har','Wal','Sieg','Rein'],b:['bert','hard','mund','wig','fried','trud','olf','helm']},
  hellenique:{n:'Hellénique',a:['Thera','Kall','Nike','Phil','Aris','Xen','Lyk','Demo'],b:['on','andros','ide','issa','kles','pous','thea','oros']},
  persane:{n:'Persane',a:['Dara','Ard','Ferey','Shah','Bah','Rostam','Nav','Kav'],b:['var','shir','dokht','mehr','zad','bad','naz','pur']},
  bantoue:{n:'Bantoue',a:['Nde','Kambe','Zola','Mwe','Buka','Tenda','Simu','Nala'],b:['nge','mba','lwa','ndi','tsi','zwe','mane','ka']},
  andine:{n:'Andine',a:['Illa','Kusi','Amaru','Wayra','Puma','Inti','Sami','Rumi'],b:['yoc','wasi','nina','qota','runa','chay','maru','tica']},
