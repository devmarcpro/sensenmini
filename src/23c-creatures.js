...
const CREATURE={
  ...
  auroch:{n:'Auroch noir',g:'牛',cat:'bete',bio:['plaine','taiga','steppe'],minp:3,lv:21,vec:{2:.7,0:.3},dt:'contondant',delay:3.6,wind:1.7,hp:2.0,dmg:1.6,arm:1.5,tame:1,pack:[1,2],pat:['lourd','simple','balayage'],mats:['cuir','os','fourrure']},
  ...
  ourse:{n:'Ourse des ronces',g:'熊',cat:'bete',bio:['foret','marecage','jungle'],minp:4,lv:25,vec:{2:.6,0:.4},dt:'tranchant',delay:3.3,wind:1.6,hp:2.1,dmg:1.8,arm:1.5,tame:1,pat:['lourd','balayage','morsure'],mats:['fourrure','cuir','os']},
  meutemaudite:{n:'Meute maudite',g:'狼',cat:'corrompu',bio:['plaine','foret','taiga','steppe'],corr:45,minp:4,lv:23,vec:{3:.5,1:.5},dt:'tranchant',delay:1.7,wind:.9,hp:1.1,dmg:1.3,arm:.8,pack:[3,5],nuit:2.5,venin:1,pat:['morsure','double','simple'],mats:['cuir','os','onyx']},
  /* --- desert et cendres --- */
  scarabee:{n:'Scarabée de fer',g:'甲',cat:'bete',bio:['desert','cendres','jungle','badlands','karst'],minp:3,lv:22,vec:{3:.8,2:.2},dt:'contondant',delay:3.4,wind:1.6,hp:1.6,dmg:1.4,arm:2.6,pat:['lourd','simple'],mats:['fer','ecaille','os']},
  vipereroi:{n:'Vipère-roi des sables',g:'蛇',cat:'bete',bio:['desert','jungle','badlands','oasis'],minp:4,lv:27,vec:{4:.5,1:.5},dt:'percant',delay:2.2,wind:.9,hp:1.4,dmg:1.9,arm:.9,venin:1,embuscade:1,pat:['morsure','crachat','double'],mats:['ecaille','os']},
  djinn:{n:'Djinn de poussière',g:'旋',cat:'corrompu',bio:['desert','cendres','badlands','salines'],corr:40,minp:5,lv:31,vec:{0:.6,2:.4},dt:'tranchant',delay:2.0,wind:1.0,hp:1.5,dmg:2.0,arm:1.0,nuee:1,affaiblit:1,pat:['balayage','double','crachat'],mats:['sable','ambre','soufre']},
  forgeronmort:{n:'Forgeron calciné',g:'鍛',cat:'corrompu',bio:['cendres','ruines'],corr:55,dj:2,minp:5,lv:34,vec:{1:.6,3:.4},dt:'contondant',delay:3.2,wind:1.6,hp:2.0,dmg:2.1,arm:2.0,brule:1,pat:['lourd','simple','balayage'],mats:['fer','cendre','obsidienne']},
  /* --- toundra, taiga, montagnes --- */
  tigredesneiges:{n:'Tigre des neiges',g:'虎',cat:'bete',bio:['toundra','montcris','taiga','banquise'],minp:4,lv:26,vec:{4:.6,3:.4},dt:'tranchant',delay:1.9,wind:.9,hp:1.5,dmg:2.0,arm:1.1,embuscade:1,tame:1,pat:['double','morsure','simple'],mats:['fourrure','os','cuir']},
  troll:{n:'Troll des cimes',g:'鬼',cat:'corrompu',bio:['montagne','montcris','karst'],corr:35,dj:1,minp:5,lv:32,vec:{2:.7,4:.3},dt:'contondant',delay:3.8,wind:2.0,hp:2.8,dmg:2.2,arm:1.9,pat:['lourd','balayage'],mats:['granitnoir','os','cuir']},
  ...
  golemgivre:{n:'Golem de givre',g:'氷',cat:'corrompu',bio:['toundra','montcris','banquise'],corr:45,minp:5,lv:33,vec:{4:.8,2:.2},dt:'contondant',delay:3.7,wind:1.9,hp:2.5,dmg:1.9,arm:2.4,pat:['lourd','balayage','crachat'],mats:['quartz','glace','argent']},
  /* --- marecages, cotes, terres corrompues --- */
  serpentmer:{n:'Serpent de mer',g:'龍',cat:'bete',bio:['cote','marecage','salines'],minp:5,lv:29,vec:{4:.9,0:.1},dt:'percant',delay:3.0,wind:1.5,hp:2.2,dmg:1.9,arm:1.4,embuscade:1,pat:['morsure','lourd','balayage'],mats:['ecaille','coquillage','os']},
